...
begin
	...
	(
		 ...
		 axi_rx_data      => slv_reg1(7 downto 0),
		 axi_rx_valid     => slv_reg1(31),
		 axi_rx_received   => slv_reg0(30),
		 
		 axi_tx_data      => slv_reg0(7 downto 0),
		 axi_tx_valid     => slv_reg0(31),
		 axi_tx_received   => slv_reg1(30),
