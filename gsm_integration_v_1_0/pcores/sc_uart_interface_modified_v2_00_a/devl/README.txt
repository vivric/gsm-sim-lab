...
Peripheral Summary:
  ...
  XPS project / EDK repository               : /home/ga38kud/vivin_gsm/gsm_sim/gsm_integration_v_1_0
  logical library name                       : sc_uart_interface_modified_v2_00_a
  top name                                   : sc_uart_interface_modified
  version                                    : 2.00.a
  type                                       : AXI4LITE slave
...
- HDL source file(s)
  ...
  hdl/vhdl/sc_uart_interface_modified.vhd
...
- XPS interface file(s)
  ...
  data/sc_uart_interface_modified_v2_1_0.mpd
  ...
  data/sc_uart_interface_modified_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/sc_uart_interface_modified.xise
  ...
  devl/projnav/sc_uart_interface_modified.tcl

    This is the TCL command line file used to generate the .xise file.

- XST synthesis file(s)

  devl/synthesis/sc_uart_interface_modified_xst.scr
  ...
  devl/synthesis/sc_uart_interface_modified_xst.prj
...
- Driver source file(s)
  ...
  src/sc_uart_interface_modified.h
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/sc_uart_interface_modified_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/sc_uart_interface_modified_v2_1_0.tcl
...
axi_lite_ipif_v1_01_a
	/nfs/tools/xilinx/ise/14.7/ISE_DS/EDK/hw/XilinxProcessorIPLib/pcores/axi_lite_ipif_v1_01_a/doc/axi_lite_ipif_ds765.pdf
