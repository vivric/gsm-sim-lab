...
// transmit protocol
	...
	if((rx_reg & axi_rx_valid_mask)){
		...
		SC_UART_mWriteReg(XPAR_SC_UART_0_BASEADDR,SC_UART_SLV_REG0_OFFSET,axi_rx_recieved_true);
		print("Waiting for axi_rx_valid to be reset by uart");
		while(SC_UART_mReadReg(XPAR_SC_UART_0_BASEADDR,SC_UART_SLV_REG1_OFFSET)&axi_rx_valid_mask);
		SC_UART_mWriteReg(XPAR_SC_UART_0_BASEADDR,SC_UART_SLV_REG0_OFFSET,axi_rx_recieved_false);
