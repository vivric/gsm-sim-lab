...
Peripheral Summary:
  ...
  logical library name                       : sc_uart_interface_v3_00_a
  top name                                   : sc_uart_interface
  version                                    : 3.00.a
  type                                       : AXI4LITE slave
...
- HDL source file(s)
  ...
  hdl/vhdl/sc_uart_interface.vhd
...
- XPS interface file(s)
  ...
  data/sc_uart_interface_v2_1_0.mpd
  ...
  data/sc_uart_interface_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/sc_uart_interface.xise
...
- XST synthesis file(s)
  ...
  devl/synthesis/sc_uart_interface_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/sc_uart_interface_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/sc_uart_interface_v2_1_0.tcl
